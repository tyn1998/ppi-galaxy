    ...
    return (
      <div className='container'>
        ...
        <div className='media-list'>
          ...
          <Destination description='interactomes 9606.'
                      href='#/galaxy/9606?l=1'
                      media=''
                      name='9606'/>
          <Destination description='interactomes 394 sparse.'
                      href='#/galaxy/sparse?l=1'
                      media=''
                      name='394 sparse'/>
          <Destination description='interactomes 394 9606 4555.'
                      href='#/galaxy/three?l=1'
                      media=''
                      name='three'/>
